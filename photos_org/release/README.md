...
基于AI技术的智能照片管理平台，支持照片去重（自动去除重复照片）上传、分析、分类、标签生成、**人脸识别与根据肖像快速查询**、**GPS转地址多服务解析**、**图像特征提取与相似照搜索**、支持对照片及其信息的增删改查、播放和下载。
...
6. 系统启动后，会自动打开默认浏览器进入照片系统
7. 注意：启动完成后，请不要关闭启动窗口
