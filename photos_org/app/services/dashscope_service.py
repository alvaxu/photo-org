...
class DashScopeService:
    ...
    def analyze_photo_content(self, image_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # 构建分析提示词
            prompt = """
请像一个专业的摄影师和图像分析师那样，深度分析这张照片。
首先，仔细观察照片的整体构图和主体内容，思考这张照片想要传达什么信息。

然后，按照以下步骤进行分析：

1. 识别照片的核心主题：这是什么类型的照片？（家庭生活/旅行/工作/社交/日常）
2. 分析场景和环境：具体在什么地方？什么氛围？
3. 识别主要元素：都有什么人或物？他们在做什么？
4. 理解情感内涵：照片传达了什么情感？
5. 提取关键特征：最能代表这张照片的3-5个核心标签

特别注意：
- 优先选择具体、有意义的标签，避免过于宽泛的词语
- 考虑照片的上下文和文化背景
- 标签应该帮助用户快速理解和找到这张照片
...

{
    ...
    "people_count": "人物数量（无人/1人/2人/3人/4人/5人/6人/7人/8人/多人）",
    "emotion": "照片传达的情感（欢乐/宁静/悲伤/兴奋/怀旧）",
    "activity": "具体活动类型（家庭聚会/孩子玩耍/亲子活动/旅行旅游/度假出游/景点观光/工作办公/会议商务/出差培训/社交聚会/派对聚餐/庆祝生日/婚礼节日/日常购物/休闲娱乐/运动健身/学习读书）",
    "time_period": "时间特征（白天/夜晚/黄昏/黎明/室内光线）",
    "location_type": "具体地点类型（家庭家里/客厅/卧室/厨房/户外公园/街道/广场/旅行景点/酒店/机场/车站/办公室/会议室/商务场所/餐厅）",
...
请确保：
1. scene_type，activity，emotion，time_period，location_type字段使用上述具体选项中的值，不在选项内的，请根据照片内容和上下文，给出最合理的值
2. 所有字段都必须填写，不能为空
